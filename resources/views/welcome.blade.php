...
<head>
    ...
    <link rel="icon" href="{{ asset('favicon.ico') }}" type="images/x-icon">
...
<body id="top">
    ...
    <section id='about' class="s-about">
        ...
        <div class="row section-header has-bottom-sep" data-aos="fade-up">
            <div class="col-full">
                <h3 class="subhead subhead--dark">Ктулху???</h3>
        ...
        <div class="row about-desc" data-aos="fade-up">
            <div class="col-full">
                <p>
                    ...
                    тварях, которые не поддаются человеческому воображению… Но одной напастью это не могло обойтись,
                    странный орден обосновался в городе и проводит свои странные ритуалы...
